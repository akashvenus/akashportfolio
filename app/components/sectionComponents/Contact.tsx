            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 md:mb-16 space-y-4">
                    ...
                    <h4 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                        Contact Me <span className="text-accent-lime">Now</span>
                    </h4>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 bg-surface border border-surface-hover rounded-lg focus:outline-none focus:border-accent-lime transition-colors text-text-primary"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                required
                                rows={6}
                                className="w-full px-4 py-3 bg-surface border border-surface-hover rounded-lg focus:outline-none focus:border-accent-lime transition-colors text-text-primary resize-none"
                        ...
                        <button
                            type="submit"
                            className="w-full sm:w-auto px-8 py-4 bg-accent-lime text-background font-semibold rounded-full hover:bg-accent-lime-hover transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
                        >
                            Send Now
                    ...
                    <div className="space-y-8">
                        <div className="bg-surface rounded-2xl p-8 space-y-6 border border-accent-lime/20">
                            <h5 className="text-2xl font-bold mb-6">Get in Touch</h5>
                            
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 bg-accent-lime/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-text-secondary">akashvenu15@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-text-secondary">Ottawa, ON</p>
                                </div>
                            </div>
                        </div>

                        {/* Social Links */}
                        <div className="bg-surface rounded-2xl p-8 border border-accent-lime/20">
                            <h5 className="text-xl font-bold mb-4">Follow Me</h5>
                            <div className="flex gap-4">
                                <a href="#" className="w-12 h-12 rounded-full bg-surface-hover hover:bg-accent-lime hover:text-background flex items-center justify-center transition-all duration-300 hover:scale-110">
