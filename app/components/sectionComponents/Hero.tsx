import TechStack from "../subComponents/tech_stack"
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 md:space-y-8">
                        <div className="space-y-2">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                                Hi, I'm <span className="text-accent-lime">Akash</span>
                            </h1>
                        ...
                        <p className="text-lg md:text-xl text-text-secondary max-w-xl">
                            I have a knack for converting problems to digital solutions. 
                        ...
                        <div className="flex gap-4 pt-4">
                            <Link 
                                ...
                                className="w-12 h-12 rounded-full bg-surface hover:bg-accent-lime hover:text-background flex items-center justify-center transition-all duration-300 hover:scale-110"
                                aria-label="GitHub"
                                target="_blank"
                            >
                        ...
                        {/* Tech Stack Section */}
                        <div className="pt-8">
                            <p className="text-sm md:text-base uppercase tracking-wider font-mono text-text-secondary mb-4">
                                Best Skills On
                            </p>
                            <TechStack/>
                        </div>
                    ...
                    <div className="hidden lg:flex justify-center items-center">
                        <div className="relative">
                            <div className="w-80 h-96 bg-linear-to-br from-surface via-surface-hover to-surface rounded-2xl shadow-2xl border border-accent-lime/20 flex items-center justify-center">
                                {/* <div className="text-center space-y-4">
                                    <div className="w-48 h-48 mx-auto rounded-full bg-accent-lime/10 border-4 border-accent-lime flex items-center justify-center">
                                        <span className="text-6xl">👨‍💻</span>
                                    </div>
                                    <p className="text-text-secondary">Your professional photo here</p>
                                </div> */}
                                <Image src='/grad.jpg' alt='Grad image' width='500' height='500'/>
                            </div>
                            {/* Decorative elements */}
                            <div className="absolute -top-4 -right-4 w-24 h-24 bg-accent-lime/10 rounded-full blur-xl"></div>
                            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-accent-pink/10 rounded-full blur-xl"></div>
                        </div>
                    </div>
                </div>
            </div>
